        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <button
              ...
              className="hidden sm:block px-4 py-2 text-slate-700 hover:text-slate-900 font-medium transition"
            >
              Pricing
            </button>
            <button
              onClick={() => setShowAuth('login')}
              className="px-3 sm:px-4 py-2 text-slate-700 hover:text-slate-900 font-medium transition text-sm sm:text-base"
            >
              Sign In
            </button>
            <button
              onClick={() => setShowAuth('signup')}
              className="px-4 sm:px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-medium hover:shadow-lg transition text-sm sm:text-base"
            >
              Get Started
            </button>
          </div>
